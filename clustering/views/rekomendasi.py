    ...
    if request.session.has_key('user'):
        ...
        if request.session.has_key('avg_score_rfm') and request.session.has_key('avg_score_lrfm'):
            if request.session['avg_score_rfm'] > request.session['avg_score_lrfm']:
                ...
                if request.session.has_key('validasi_rfm'):
                     context['validasi_topsis'] = request.session['validasi_rfm']
                ...
                if request.session.has_key('validasi_lrfm'):
                     context['validasi_topsis'] = request.session['validasi_lrfm']
...
def clear_rekomendasi(request):
    try:
        ...
        if request.session.has_key("data_topsis_rfm") and request.session.has_key("validasi_rfm"):
        ...
        if request.session.has_key("data_topsis_lrfm") and request.session.has_key("validasi_lrfm"):
